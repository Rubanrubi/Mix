...
<div class="side-navigation-menu">
    ...
    <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
        ...
        <ul class="navigation-menu">
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">weekend</span>Agency
                    kit</a>
                <ul>
                    <li><a class="is-submenu" href="#">Homepage</a></li>
                    <li><a class="is-submenu" href="#">About</a></li>
                    <li><a class="is-submenu" href="#">Portfolio</a></li>
                    <li><a class="is-submenu" href="#">Contact</a></li>
                    <li><a class="is-submenu" href="#">Blog</a></li>
                    <li><a class="is-submenu" href="#">Post no sidebar</a></li>
                </ul>
            </li>
            ...
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">apps</span>Landing kit
                    1</a>
                <ul>
            ...
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">timelapse</span>Landing
                    kit 2</a>
                <ul>
            ...
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">assistant</span>Landing
                    kit 3</a>
                <ul>
            ...
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">brightness_2</span>Landing
                    kit 4</a>
                <ul>
            ...
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">toys</span>Landing kit
                    5</a>
                <ul>
            ...
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">mouse</span>Landing
                    kit 6</a>
                <ul>
        ...
        <ul class="navigation-menu">
            ...
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">playlist_add</span>Advanced
                ...
                <ul>
                    ...
                    <li><a class="is-submenu" href="#">Calendar</a></li>
                </ul>
            </li>
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">check_box</span>Forms</a>
                <ul>
                    <li><a class="is-submenu" href="#">Inputs</a></li>
                    <li><a class="is-submenu" href="#">Controls</a></li>
                    <li><a class="is-submenu" href="#">Form layouts</a></li>
                    <li><a class="is-submenu" href="#">Step forms</a></li>
                    <li><a class="is-submenu" href="#">Uploader</a></li>
                </ul>
            </li>
            <li class="has-children"><a class="parent-link" href="#"><span class="material-icons">adjust</span>Icons</a>
                <ul>
                    <li><a class="is-submenu" href="#">Icons Mind</a></li>
                    <li><a class="is-submenu" href="#">Simple Line Icons</a></li>
                    <li><a class="is-submenu" href="#">Font Awesome</a></li>
                    <li><a class="is-submenu" href="#" target="_blank">Material Icons</a></li>
                    <li><a class="is-submenu" href="#">Icon Picker</a></li>
                </ul>
            </li>
        </ul>
    </div>
